"""Compact student vocab for exp05 (same recipe as exp03/exp04): count Gemma
token frequencies over the ring training chunks (000-004 x 7 shards = 35
files, 87,500 docs; chunk005 excluded entirely — it contains the eval split),
