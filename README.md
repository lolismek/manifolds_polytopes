...
| Sarfati, Lubana et al. — *The Shape of Beliefs* (Goodfire) | [2602.02315](https://arxiv.org/abs/2602.02315) | Posterior manifolds in pretrained Llama over in-context number-distribution parameters; linear field probes; on- vs off-manifold steering. Numerical settings only; names natural language as open. |
| Morgulis, Hewitt — *Subliminal Steering* | [2604.25783](https://arxiv.org/abs/2604.25783) | Steered teacher → generated data → student inherits bias and steering direction (same-base fine-tune). Feasibility evidence for the exp03 channel; motivates paraphrase control. |
